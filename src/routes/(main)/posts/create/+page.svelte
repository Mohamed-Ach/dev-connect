...
<div class="grid xl:grid-cols-2 gap-5">
	<Card cardTitle="Create a new Post">
		<div class="space-y-3">
			<TextInput
				label="Post Title*"
				id="pn"
			...
			<div class="mb-4">
				<label for="select languages" class="form-label">
					Select the relevant programming languages :
				</label>
				<!-- Select -->
				<MultiSelect
			...
			<div class="mb-4">
				<label for="select languages" class="form-label"> Select the relevant technologies :</label>
				<!-- Select -->
				<MultiSelect
